...
- **iOS**: SwiftUI + StoreKit 2. Any StoreKit purchase flow must reconcile with the backend's Stripe Connect state; the two must never disagree about payment status.
